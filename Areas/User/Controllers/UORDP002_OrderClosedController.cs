...
namespace FreshBox.Areas.User.Controllers
{
    public class UORDP002_OrderClosedController : BaseController
    {
        ...
        {
            using var datas = new z_repoOrderClosed(SessionService.SortColumn, SessionService.SortDirection);
        ...
        public IActionResult CreateEdit(int id = 0)
        {
            ...
            using var datas = new z_repoOrderClosed();
        ...
        public IActionResult CreateEdit(Orders model)
        {
            ...
            using var orders = new z_repoOrderClosed();

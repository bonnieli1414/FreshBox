...
{
    public class UORGP004_EmployeeController : Controller
    {
        /// <summary>
        /// 資料初始化事件
        /// </summary>
        ...
        {
            using var datas = new z_repoEmployees(SessionService.SortColumn, SessionService.SortDirection);
        ...
        public IActionResult CreateEdit(int id = 0)
        {
            ...
            using var datas = new z_repoEmployees();

...
{
    public class UORDP005_CategoryController : Controller
    {
        /// <summary>
        /// 資料初始化事件
        /// </summary>
        ...
        {
            using var Categorys = new z_repoCategorys(SessionService.SortColumn, SessionService.SortDirection);
            var model = Categorys.GetDataList(SessionService.SearchText)
        ...
        public IActionResult CreateEdit(int id = 0)
        {
            ...
            {
                //修改資料
                using var Categorys = new z_repoCategorys();
                model = Categorys.GetData(id);
        ...
        public JsonResult DeleteRow(int id = 0)
        {
            ...
            using (z_repoCategorys Categorys = new z_repoCategorys())
            {
                Categorys.Delete(id);
